# services/deathfinder/select_chunks_embeddings.py
#!/usr/bin/env python
# -*- coding: utf-8 -*-
...
def find_death_chunks(person_name: str,
                      embedded_path: Path,
                      topk: int = 3,
    ...
    query = f"death information or recent activity of {person_name}"
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Semantic search for death/alive chunks.")
    ...
    results = find_death_chunks(args.person, args.embedded, topk=args.topk)
